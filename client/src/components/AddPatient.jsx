...
const AddPatient = ({ setPatients, setStats, stats }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false);
      setError("Error creating patient, check your internet connection");
      setSuccess("");
      ...
      <Dialog>
        ...
        <DialogContent className="max-w-[90%] md:max-w-[500px] lg:max-w-[1000px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Fill out the form to create a new patient record and get heart
              failure prediction
            </DialogDescription>
          </DialogHeader>
              ...
              {save && (
                <form
                  ...
                  onSubmit={async (e) => {
                    ...
                    await CreatePatient(patientData, setLoading, Navigate);
                    setLoading(false);
